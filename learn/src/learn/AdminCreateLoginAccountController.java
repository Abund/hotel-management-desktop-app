 ...
 * @author Abun
 */
public class AdminCreateLoginAccountController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     public void handleSignUpButtonAction(ActionEvent event) throws IOException{
            sqmod1.inserttoAdmin(firstName.getText(),lastName.getText(),username.getText(),email.getText(),passwordField.getText());
